...
const ChoixEquipeData: ChoixEquipeInterface[] = [
    {
        ...
        imageAlt: "Une tente representant la pizza campagnarde pomme de terre et jambon de campagne",
    ...
    {id: uuidv4(),
        ...
        imageAlt: "Un burger representant la pizza burger viande hachée et poivrons",
        title: "LA BURGER",
    ...
    {id: uuidv4(),
        ...
        imageAlt: "Une abeille representant la pizza abeille avec chevre et miel",
        title: "L\'ABEILLE",
    ...
    {id: uuidv4(),
        ...
        imageAlt: "Une chevre representant la pizza poitevine avec fromage et champignons",
        title: "LA POITEVINE",
