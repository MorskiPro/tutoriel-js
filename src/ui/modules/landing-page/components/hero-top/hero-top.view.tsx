...
export const HeroTopView = () => {
    return (
        ...
        <Image src="/assets/images/pizzab.png" alt="Une pizza" width={700} height={700} className="relative sm:absolute top-0 right-0 z-0"/>
            <div>
                ...
                <Typography variant="body-sm" component="p" className="max-w-xl pt-3 leading-6 p-5 text-center sm:text-left" theme="white">Chez Label Pizza toutes nos pizzas sont garnies de produits régionaux et cuites sur place, dans le camion, au feu de bois.</Typography>
            </div>    
